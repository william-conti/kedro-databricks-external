...
# kedro_pyspark_iris documentation build
...
from kedro_pyspark_iris import __version__ as release

# -- Project information -----------------------------------------------------

project = "kedro_pyspark_iris"
author = "Kedro"
...
htmlhelp_basename = "kedro_pyspark_irisdoc"
...
latex_documents = [
    (
        master_doc,
        "kedro_pyspark_iris.tex",
        "kedro_pyspark_iris Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "kedro_pyspark_iris",
        "Project kedro_pyspark_iris codebase.",
        "Nearest-Neighbour",
    )
]
